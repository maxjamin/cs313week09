...
function calculateRate() {
		...
		var weight = Double(request.query.weightOfItem); //document.getElementById("weightOfItem").value;
		var typeOf = String(request.query.postalType); //document.getElementById("postalType").value;
		var cost = 0;
